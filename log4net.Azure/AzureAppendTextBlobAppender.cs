...
{
    public class AzureAppendTextBlobAppender : BufferingAppenderSkeleton
    {
        ...
        {
            var appendBlob = _cloudBlobContainer.GetAppendBlobReference(Filename(_directoryName));
            var text = _lineFeed + loggingEvent.RenderedMessage;
        ...
        {
            return
                $"{directoryName}/{DateTime.Today.ToString("yyyy_MM_dd", DateTimeFormatInfo.InvariantInfo)}.entry.log";
        }
